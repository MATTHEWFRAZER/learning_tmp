...
if(__boost_variants AND NOT __boost_configs)
  message(STATUS "No suitable boost_test_exec_monitor variant has been identified!")
  if(NOT Boost_DEBUG)
  ...
  set(boost_test_exec_monitor_NOT_FOUND_MESSAGE "No suitable build variant has been found.")
...
foreach(dep_boost_test_exec_monitor IN LISTS _BOOST_TEST_EXEC_MONITOR_DEPS)
  ...
  get_filename_component(_BOOST_CMAKEDIR "${CMAKE_CURRENT_LIST_DIR}/../" ABSOLUTE)
  find_package(boost_${dep_boost_test_exec_monitor} 1.70.0 EXACT CONFIG ${_BOOST_REQUIRED} ${_BOOST_QUIET} HINTS ${_BOOST_CMAKEDIR})
