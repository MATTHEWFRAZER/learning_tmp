...
if(__boost_variants AND NOT __boost_configs)
  message(STATUS "No suitable boost_stacktrace_noop variant has been identified!")
  if(NOT Boost_DEBUG)
  ...
  set(boost_stacktrace_noop_NOT_FOUND_MESSAGE "No suitable build variant has been found.")
...
foreach(dep_boost_stacktrace_noop IN LISTS _BOOST_STACKTRACE_NOOP_DEPS)
  ...
  get_filename_component(_BOOST_CMAKEDIR "${CMAKE_CURRENT_LIST_DIR}/../" ABSOLUTE)
  find_package(boost_${dep_boost_stacktrace_noop} 1.70.0 EXACT CONFIG ${_BOOST_REQUIRED} ${_BOOST_QUIET} HINTS ${_BOOST_CMAKEDIR})
